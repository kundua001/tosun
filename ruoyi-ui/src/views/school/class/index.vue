<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="班主任联系电话" prop="mobile">
        <el-input
      ...
      <el-form-item label="班主任" prop="contact">
        <el-input
      ...
      <el-form-item label="logo图片的url" prop="logoUrl">
        <el-input
          v-model="queryParams.logoUrl"
          placeholder="请输入logo图片的url"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班主任联系电话" align="center" prop="mobile" />
      <el-table-column label="班主任" align="center" prop="contact" />
      <el-table-column label="logo图片的url" align="center" prop="logoUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="班主任联系电话" prop="mobile">
          <el-input v-model="form.mobile" placeholder="请输入班主任联系电话" />
        </el-form-item>
        <el-form-item label="班主任" prop="contact">
          <el-input v-model="form.contact" placeholder="请输入班主任" />
        </el-form-item>
        <el-form-item label="logo图片的url" prop="logoUrl">
          <el-input v-model="form.logoUrl" placeholder="请输入logo图片的url" />
        </el-form-item>
        <el-form-item label="学生数量" prop="studentNum">
