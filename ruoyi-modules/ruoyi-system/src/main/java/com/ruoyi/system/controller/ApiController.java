...
public class ApiController extends BaseController
{
    ...
    public R<LoginUser> infoByMobile(@PathVariable("mobile") String mobile)
    {
    ...
    public AjaxResult getUserInfo()
    {
        ...
        user = eduUserService.selectEduUserByUserId(userId);
        // 学校信息
        if(null != user ){
//            if( null != user.getSchoolId()){
//                school = eduSchoolService.selectEduSchoolById(user.getSchoolId());
//            }
            // 班级信息
//            if( null != user.getClassId()){
//                EduClass eduClass1 = new EduClass();
//                eduClass1.setIds();
//                eduClass = eduClassService.selectEduClassList(user.getClassId());
//            }
        }
        eduTeacher = eduTeacherService.selectEduTeacherByUserId(userId);
        // 学校信息
        if(null != eduTeacher ){
//            if( null != eduTeacher.getSchoolId()){
//                school = eduSchoolService.selectEduSchoolById(eduTeacher.getSchoolId());
//            }
            // 班级信息
            if( null != eduTeacher.getClassId()){
                eduClass = eduClassService.selectEduClassById(eduTeacher.getClassId());
            }
        }
        AjaxResult ajax = AjaxResult.success();
        ajax.put("user", user);
//        ajax.put("school", school);
        ajax.put("eduClass", eduClass);
        ajax.put("teacher", eduTeacher);
        return ajax;
    }
    /**
     * 根据用户编号获取详细信息
